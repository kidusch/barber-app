...
chmod 644 $REMOTE_DIR/public/test.php;
chmod 644 $REMOTE_DIR/.env;
chmod -R 755 $REMOTE_DIR/var;
chmod -R 755 $REMOTE_DIR/public;
chmod -R 755 $REMOTE_DIR/config;
chmod -R 755 $REMOTE_DIR/src;
chmod -R 755 $REMOTE_DIR/vendor;
chmod -R 755 $REMOTE_DIR/bin;
chmod 755 $REMOTE_DIR/bin/console;
quit;
"
...
echo "Please try accessing these URLs to verify the setup:"
echo "1. http://barber-dashboard.abyssinia-vs.ch/test.php (Should show PHP info)"
echo "2. http://barber-dashboard.abyssinia-vs.ch/ (Should show your Symfony app)" 